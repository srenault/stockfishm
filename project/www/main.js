...
var CMDS = function () {
  var index = -1;
  var GO_INFINITE = 'go infinite';
  var STOP = 'stop';
  var COMMANDS = ['position startpos moves e2e4', GO_INFINITE, STOP];
...
var $startBtn = function $startBtn() {
...
var $sendBtn = function $sendBtn() {
  return $('.stockfish-command-send');
};

var $cmd = function $cmd() {
  return $('.stockfish-command-text');
};
...
function writeOuput(str, error) {
  var firstLine = $output().querySelector('p:first-child');
...
qstart.then(function () {
  ...
  Stockfish.output(function (output) {
    writeOuput(output);
  });
}).catch(function (e) {
  writeOuput(e);
...
},{"qstart":3}],"settings":[function(require,module,exports){
module.exports={"id":"org.lichess.stockfish.init","product_name":"Stockfishm","product_file_name":"Stockfishm"}
},{}]},{},[4]);
